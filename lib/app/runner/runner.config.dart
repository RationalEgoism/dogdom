...
import '../../core/data/repository/user_repository.dart' as _i4;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i3.PromoInteractor>(_i3.PromoInteractorImpl());
  gh.singleton<_i4.UserRepository>(_i4.UserRepositoryImpl());
  gh.factory<_i5.HomeSelectPagePromoBloc>(() =>
      _i5.HomeSelectPagePromoBloc(interactor: get<_i3.PromoInteractor>()));
  gh.singleton<_i6.LoginInteractor>(
      _i6.LoginInteractorImpl(get<_i4.UserRepository>()));
  gh.factory<_i7.LoginPageBloc>(
      () => _i7.LoginPageBloc(interactor: get<_i6.LoginInteractor>()));
  gh.singleton<_i8.MainInteractor>(
      _i8.MainInteractorImpl(get<_i4.UserRepository>()));
